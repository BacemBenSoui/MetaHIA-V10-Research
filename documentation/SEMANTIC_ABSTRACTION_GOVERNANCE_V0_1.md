...
| JEV-LABELED | 🟡 mesuré quatre fois (22/22 cas contre Jev officiel Sec. 2 ; 22 cas puis 39 cas contre Kev-0.8B réel, Sec. 6ter/6quater ; puis 13 ordres de critères × 39 cas, Sec. 6sexies) — **meilleur compromis global ET meilleure calibration mesurée au baseline** (Brier 0,377, ECE 0,137) ; mais P8.3a montre que ce résultat n'est **pas pleinement invariant à l'ordre des critères** : précision globale de 61,5 % à 82,1 % selon l'ordre (σ=7,6 pts, moins fragile que STRICT mais pas insensible), et la résistance à « conjoint » sur 4/4 paraphrases **échoue dans 8/13 ordres testés** -- pas une propriété garantie ; confond toujours `EPOUX_DE`/`EPOUSE_DE` (sens inverse de STRICT), et cette confusion **résiste à la séparation positionnelle** (100 % dans les 3 ordres conçus, contrairement à l'hypothèse testée) ; en revanche `MERE_DE`/`PERE_DE` n'est confondu dans AUCUN des 13 ordres -- candidat par défaut toujours le mieux justifié, mais adoption définitive volontairement pas encore prononcée |

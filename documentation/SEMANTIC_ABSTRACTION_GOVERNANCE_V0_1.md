...
| JEV-STRICT | 🟡 mesuré (2026-09-22, 22 cas contre Kev-0.8B réel, `documentation/P8_Jev_Kev_Local_Decision_Model_V0_1.md` Sec. 6ter) — précision positive 62,5 %, mais robustesse adversariale faible (16,7 % — échoue sur négation/question/conditionnel/hors-vocabulaire/quasi-synonyme avec seulement 5 exemples travaillés) ; seule condition validant réellement l'hypothèse d'abstraction pour un LLM, mais le protocole minimal actuel ne suffit pas encore à une robustesse comparable aux autres conditions |
| JEV-LABELED | 🟢 mesuré (22/22 cas contre Jev officiel, Sec. 2 ; + 22 cas contre Kev-0.8B réel, Sec. 6ter, précision globale 72,7 %, **meilleur compromis global mesuré** — robustesse adversariale 66,7 %, la meilleure des trois conditions) — **reclassé** depuis « strict » implicite vers LABELED par ce document |
| JEV-GLOSSED | 🟡 mesuré (2026-09-22, 22 cas contre Kev-0.8B réel, Sec. 6ter) — précision positive maximale (100 %) mais robustesse adversariale dégradée (50 %) : reproduit, avec un second modèle indépendant, l'échec de coercition « conjoint → EPOUX_DE » déjà mesuré sur Jev officiel (Sec. 2) — la glose semble accroître, pas réduire, ce risque précis |

"""MetaHIA P6.2 -- three-domain multi-seed statistical stability probe.

Extends P5.2's two-domain multi-seed probe with the third Supply Chain
domain, to test directly whether adding a third independent domain shrinks
the already-documented split-sensitivity of the COMBINED holdout Brier/ECE
(P5 Sec.5: combined-two mean Brier=0.444565, population std=0.107167 over
seeds 0-9). No M6 tuning. No promotion threshold changed.
"""
